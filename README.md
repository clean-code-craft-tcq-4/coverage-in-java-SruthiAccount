...
for the coding part i perform ensure that the there is no duplication of lines and one method does only one functionality.
Also for the code reviews i do i will check the same.
